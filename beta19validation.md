...
| Issues de GitHub | `admiral-project/admiral` | En curso | La revisión upstream con `gh issue list/view` confirma #3, #4 y #12 cerrados. El issue [#4](https://github.com/admiral-project/admiral/issues/4) quedó cerrado el 2026-08-01 con HTTPS real, validación TLS, `ADMIRAL_INSECURE_SKIP_VERIFY` desactivado, objeto remoto verificado y restore con checksum. Permanecen abiertos #5, #6, #10, #14, #16 y #17; no se mezclan con la validación S3 ya cerrada. |
