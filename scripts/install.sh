...
EXTRA_VARS_JSON=$(
    ...
    ADMIRAL_EGRESS_IPV4_DESTINATIONS="${ADMIRAL_EGRESS_IPV4_DESTINATIONS:-}" \
    ADMIRAL_EGRESS_IPV6_DESTINATIONS="${ADMIRAL_EGRESS_IPV6_DESTINATIONS:-}" \
    ADMIRAL_EGRESS_IPV6_ENABLED="${ADMIRAL_EGRESS_IPV6_ENABLED:-}" \
    ADMIRAL_AUDITD_IMMUTABLE="${ADMIRAL_AUDITD_IMMUTABLE:-}" \
