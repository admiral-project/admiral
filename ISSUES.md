...
- `admiral-harbor#29` is a real issue and was fixed in submodule commit
...
- `admirald#38` is a real issue and was fixed in submodule commit `728b1fd`:
...
- `admiralctl#16` is a real issue and was fixed in submodule commit `557f605`:
...
- `admiralctl#12` is a real security issue and was fixed in submodule commit
  ...
  recorded in `11b3a8f`; the release-reference validator passes.
- `admiralctl#11` is a real security issue and was fixed in submodule commit
...
- `admiral-harbor#27` is a real security issue and was fixed in submodule
  ...
  release-reference validator passes.
- `admiral-flagship#9` is a real security issue and was fixed in submodule
  ...
  validator passes.
- `admiral-flagship#10` is a real configuration issue and was fixed in
...
- `admiral-fleet#49` is a real issue and was fixed in submodule commit
  ...
  validation pass.
- `admiral-fleet#48` is a real issue and was fixed in submodule commit
  `eb9a7da`: direct HTTPS and S3 restore downloads now read at most the
  configured 1 GiB artifact limit and reject oversized objects. The S3 limit
...
- **GitHub status:** Closed 2026-07-15. Remediated in `886f9e6`; installer
  syntax and mode-contract tests pass.
